...
class CocktailRecommender:
    ...
    def search_similar_cocktails(self, query_embedding, limit=10, similarity_threshold=0.3):
        ...
        try:
            ...
            cursor.execute("""
                SELECT id, name, ingredients, recipe, glass, category, alcoholic,
    ...
    def format_cocktail_result(self, result):
        ...
        if len(result) == 8:  # With similarity score
            id, name, ingredients, recipe, glass, category, alcoholic, similarity = result
            return {
                'id': id,
                'name': name,
            ...
            id, name, ingredients, recipe, glass, category, alcoholic = result
            return {
                'id': id,
                'name': name,
                'ingredients': ingredients,
